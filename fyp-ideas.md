...
On the site: [Web project ideas](https://www.sefism.com/fyp-ideas/?domain=web)
...
On the site: [Mobile project ideas](https://www.sefism.com/fyp-ideas/?domain=mobile)

| Idea | Difficulty | Suggested stack |
| --- | --- | --- |
| [Local Market Price Transparency App](https://www.sefism.com/fyp-ideas/local-market-price-transparency-app/) | Beginner | Flutter, Firebase, Node.js, PostgreSQL |
...
| [Receipt Scanning Expense Splitter](https://www.sefism.com/fyp-ideas/receipt-scanning-expense-splitter/) | Intermediate | React Native, Tesseract OCR, Node.js, PostgreSQL |
| [Indoor Navigation Using Bluetooth Beacons](https://www.sefism.com/fyp-ideas/indoor-navigation-using-bluetooth-beacons/) | Advanced | Kotlin, Android, BLE, Node.js |

## AI & ML

On the site: [AI & ML project ideas](https://www.sefism.com/fyp-ideas/?domain=ai_ml)

| Idea | Difficulty | Suggested stack |
| --- | --- | --- |
| [Adaptive Study Planner with Spaced Repetition](https://www.sefism.com/fyp-ideas/adaptive-study-planner-with-spaced-repetition/) | Beginner | Python, Django, PostgreSQL, React |
...
| [Evaluation Harness for Language Model Applications](https://www.sefism.com/fyp-ideas/evaluation-harness-for-language-model-applications/) | Advanced | Python, FastAPI, PostgreSQL, React |
| [Evidence-Grounded Pull Request Review Agent](https://www.sefism.com/fyp-ideas/evidence-grounded-pull-request-review-agent/) | Advanced | Python, GitHub Actions, Tree-sitter, PostgreSQL |
| [Multi-Step Agent Workflow Runner with Cost Tracking](https://www.sefism.com/fyp-ideas/multi-step-agent-workflow-runner-with-cost-tracking/) | Advanced | Python, FastAPI, PostgreSQL, Redis |
| [Offline Coding Assistant on Consumer Hardware](https://www.sefism.com/fyp-ideas/offline-coding-assistant-on-consumer-hardware/) | Advanced | Python, llama.cpp or Ollama, Tree-sitter, VS Code Extension API |
| [On-Device Speech Recognition for an Under-Served Language](https://www.sefism.com/fyp-ideas/on-device-speech-recognition-for-an-under-served-language/) | Advanced | Python, PyTorch, Whisper, ONNX Runtime |
| [Real-Time Sign Language Recognition](https://www.sefism.com/fyp-ideas/real-time-sign-language-recognition/) | Advanced | Python, PyTorch, MediaPipe, OpenCV |

## Data & Analytics

On the site: [Data & Analytics project ideas](https://www.sefism.com/fyp-ideas/?domain=data)
...
On the site: [IoT & Embedded project ideas](https://www.sefism.com/fyp-ideas/?domain=iot_embedded)

| Idea | Difficulty | Suggested stack |
| --- | --- | --- |
| [Distributed Air Quality Sensor Mesh](https://www.sefism.com/fyp-ideas/distributed-air-quality-sensor-mesh/) | Intermediate | ESP32, C++, LoRa, MQTT |
| [Non-Intrusive Smart Energy Meter](https://www.sefism.com/fyp-ideas/non-intrusive-smart-energy-meter/) | Intermediate | ESP32, C++, CT sensors, MQTT |
| [Soil Moisture Driven Irrigation Controller](https://www.sefism.com/fyp-ideas/soil-moisture-driven-irrigation-controller/) | Intermediate | ESP32, C++, MQTT, Node.js |
| [Cold Chain Monitoring for Vaccine Transport](https://www.sefism.com/fyp-ideas/cold-chain-monitoring-for-vaccine-transport/) | Advanced | ESP32, C, LoRaWAN, FastAPI |
| [Livestock Health and Movement Monitoring](https://www.sefism.com/fyp-ideas/livestock-health-and-movement-monitoring/) | Advanced | nRF52, C, LoRa, Python |
| [Wearable Fall Detection for Independent Living](https://www.sefism.com/fyp-ideas/wearable-fall-detection-for-independent-living/) | Advanced | nRF52, C, TensorFlow Lite Micro, BLE |

## Security

On the site: [Security project ideas](https://www.sefism.com/fyp-ideas/?domain=security)
...
| [Static Analyser for Insecure Code Patterns](https://www.sefism.com/fyp-ideas/static-analyser-for-insecure-code-patterns/) | Advanced | Python, tree-sitter, FastAPI, React |

## Cloud & DevOps

On the site: [Cloud & DevOps project ideas](https://www.sefism.com/fyp-ideas/?domain=cloud_devops)
...
On the site: [Games & XR project ideas](https://www.sefism.com/fyp-ideas/?domain=game)
...
On the site: [Other project ideas](https://www.sefism.com/fyp-ideas/?domain=other)
